      ...
      setSources(
        sources.map((source) => {
          ...
          return markSourceAsPendingImport({
            ...
            providerKey: type === "url" ? source.providerKey : undefined,
            providerMode: type === "url" ? source.providerMode : undefined,
            providerGroupName: type === "url" ? source.providerGroupName : undefined,
            providerFilter: type === "url" ? source.providerFilter : undefined,
